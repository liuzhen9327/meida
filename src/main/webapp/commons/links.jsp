...
<link href="<%=request.getContextPath()%>/css/bootstrap-override.min.css" rel="stylesheet">
...
<link href="<%=request.getContextPath()%>/css/animate.delay.min.css" rel="stylesheet">
...
<link href="<%=request.getContextPath()%>/css/lato.min.css" rel="stylesheet">
<link href="<%=request.getContextPath()%>/css/roboto.min.css" rel="stylesheet">

<link href="<%=request.getContextPath()%>/css/style.default.min.css" rel="stylesheet">
